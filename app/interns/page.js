...
const HEADER_MAP={'Nama Lengkap':'name','Nama':'name','Email':'email','NIM/NIS':'nim_nis','Jenis Kelamin':'gender','Gender':'gender','No. Handphone':'phone','Telepon':'phone','NIK':'nik','Tanggal Lahir':'birthDate','Alamat':'address','Perguruan Tinggi/Sekolah':'university','Instansi':'university','Jenjang':'jenjang','Jurusan':'major','Nama Bank':'bankName','Bank':'bankName','Nomor Rekening':'bankAccount','No. Rekening':'bankAccount','Pemilik Rekening':'bankAccountName','Atas Nama Rekening':'bankAccountName','Status':'status','Bidang':'bidang','Wilayah Kerja':'wilayah','Wilayah':'wilayah','Tahun':'tahun','Tanggal Mulai':'periodStart','Mulai':'periodStart','Tanggal Selesai':'periodEnd','Selesai':'periodEnd','SPK/Perjanjian':'spk','Tanggal SPK':'tanggalSPK','Surat Penerimaan':'suratPenerimaan','Tanggal Surat Penerimaan':'tanggalSuratPenerimaan','Surat Selesai':'suratSelesai','Tanggal Surat Selesai':'tanggalSuratSelesai','Nama Pembimbing':'supervisorName','Jabatan Pembimbing':'supervisorTitle'}
